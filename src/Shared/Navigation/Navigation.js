...
const Navigation = () => {
    ...
    return (
        <Navbar bg='light' variant='light' collapseOnSelect style={{ color: '#663333', height: '70px' }} expand="lg" >
            <Container fluid>
                    ...
                    <Nav >
                        {
                            user.email ? <div className='d-flex align-items-center'> {user.displayName}
                                <Button style={{ ...linkColor, backgroundColor: 'transparent', border: 'none' }} onClick={logOut} className='px-2 link-hover'><FontAwesomeIcon icon={faSignOutAlt} /> Logout</Button></div> : <div>
